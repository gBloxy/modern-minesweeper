...
class RessourceManager():
    def __init__(self):
        ...
        self.refresh_sound = load_sound('refresh.ogg', 0.2)
...
async def main():
    global keys, key_timer, scrolling, show_starting_tile, screen_shake, screen_shake_timer, offset, dc, sett, cam, mouse_pos, left_click, start_time
    sett = Settings()
    cam = Camera()
